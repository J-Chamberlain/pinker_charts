...
| 15-9 | Child labor, 1850-2012 | verified_reproduction | processed | not_reviewed |
...
- Metadata: [figures/15-4/figure.json](figures/15-4/figure.json)
- Original reference: [references/figures/figure_15_4.png](references/figures/figure_15_4.png)
- Book period reconstruction: [figures/15-4/plots/figure_15_4_book_period.png](figures/15-4/plots/figure_15_4_book_period.png)
- Extended reconstruction: [figures/15-4/plots/figure_15_4_extended.png](figures/15-4/plots/figure_15_4_extended.png)
- Book period clean: [figures/15-4/data/clean/figure_15_4_book_period.csv](figures/15-4/data/clean/figure_15_4_book_period.csv)
- Successor clean: [figures/15-4/data/clean/figure_15_4_successor.csv](figures/15-4/data/clean/figure_15_4_successor.csv)
- Book period comparison: [figures/15-4/plots/comparisons/figure_15_4_book_period_review.png](figures/15-4/plots/comparisons/figure_15_4_book_period_review.png)
- Extended comparison: [figures/15-4/plots/comparisons/figure_15_4_extended_review.png](figures/15-4/plots/comparisons/figure_15_4_extended_review.png)
- Caption: [figures/15-4/captions/caption.txt](figures/15-4/captions/caption.txt)
- Provenance: [figures/15-4/provenance/provenance.md](figures/15-4/provenance/provenance.md)
- Source log: [figures/15-4/source_logs/source_log.md](figures/15-4/source_logs/source_log.md)
- Anomaly review: [figures/15-4/anomaly_reviews/anomaly_review.md](figures/15-4/anomaly_reviews/anomaly_review.md)
- Discrepancy log: [figures/15-4/discrepancy_logs/discrepancy_log.md](figures/15-4/discrepancy_logs/discrepancy_log.md)
- Review checklist: [figures/15-4/review_checklist.md](figures/15-4/review_checklist.md)
- Lineage: [figures/15-4/lineage/lineage.json](figures/15-4/lineage/lineage.json)
- Reconstruction script: [scripts/reconstruct_15_4.py](scripts/reconstruct_15_4.py)

### Figure 15-5 - Decriminalization of homosexuality, 1791-2016

Status: `partial_match`. Artifact kind: `reconstruction`.

- Metadata: [figures/15-5/figure.json](figures/15-5/figure.json)
- Original reference: [references/figures/figure_15_5.png](references/figures/figure_15_5.png)
- Book period reconstruction: [figures/15-5/plots/figure_15_5_book_period.png](figures/15-5/plots/figure_15_5_book_period.png)
- Extended reconstruction: [figures/15-5/plots/figure_15_5_extended.png](figures/15-5/plots/figure_15_5_extended.png)
- Book period clean: [figures/15-5/data/clean/figure_15_5_book_period.csv](figures/15-5/data/clean/figure_15_5_book_period.csv)
- Successor clean: [figures/15-5/data/clean/figure_15_5_successor.csv](figures/15-5/data/clean/figure_15_5_successor.csv)
- Book period comparison: [figures/15-5/plots/comparisons/figure_15_5_book_period_review.png](figures/15-5/plots/comparisons/figure_15_5_book_period_review.png)
- Extended comparison: [figures/15-5/plots/comparisons/figure_15_5_extended_review.png](figures/15-5/plots/comparisons/figure_15_5_extended_review.png)
- Caption: [figures/15-5/captions/caption.txt](figures/15-5/captions/caption.txt)
- Provenance: [figures/15-5/provenance/provenance.md](figures/15-5/provenance/provenance.md)
- Source log: [figures/15-5/source_logs/source_log.md](figures/15-5/source_logs/source_log.md)
- Anomaly review: [figures/15-5/anomaly_reviews/anomaly_review.md](figures/15-5/anomaly_reviews/anomaly_review.md)
- Discrepancy log: [figures/15-5/discrepancy_logs/discrepancy_log.md](figures/15-5/discrepancy_logs/discrepancy_log.md)
...
- Original reference: [references/figures/figure_15_7.png](references/figures/figure_15_7.png)
- Provenance: [figures/15-7/provenance/provenance.md](figures/15-7/provenance/provenance.md)
- Source log: [figures/15-7/source_logs/source_log.md](figures/15-7/source_logs/source_log.md)
- Search log: [figures/15-7/search_iterations/search_iterations.md](figures/15-7/search_iterations/search_iterations.md)
- Anomaly review: [figures/15-7/anomaly_reviews/anomaly_review.md](figures/15-7/anomaly_reviews/anomaly_review.md)
- Discrepancy log: [figures/15-7/discrepancy_logs/discrepancy_log.md](figures/15-7/discrepancy_logs/discrepancy_log.md)
...
- Original reference: [references/figures/figure_15_9.png](references/figures/figure_15_9.png)
- Book period reconstruction: [figures/15-9/plots/book_period/figure_15_9_book_period.png](figures/15-9/plots/book_period/figure_15_9_book_period.png)
- Extended reconstruction: [figures/15-9/plots/extended/figure_15_9_extended.png](figures/15-9/plots/extended/figure_15_9_extended.png)
- Book period clean: [figures/15-9/data/clean/figure_15_9_book_period.csv](figures/15-9/data/clean/figure_15_9_book_period.csv)
- Successor clean: [figures/15-9/data/clean/figure_15_9_successor.csv](figures/15-9/data/clean/figure_15_9_successor.csv)
- Book period comparison: [figures/15-9/plots/comparisons/figure_15_9_book_period_review.png](figures/15-9/plots/comparisons/figure_15_9_book_period_review.png)
- Extended comparison: [figures/15-9/plots/comparisons/figure_15_9_extended_review.png](figures/15-9/plots/comparisons/figure_15_9_extended_review.png)
- Caption: [figures/15-9/captions/caption.txt](figures/15-9/captions/caption.txt)
- Provenance: [figures/15-9/provenance/provenance.md](figures/15-9/provenance/provenance.md)
- Source log: [figures/15-9/source_logs/source_log.md](figures/15-9/source_logs/source_log.md)
- Search log: [figures/15-9/search_iterations/search_iterations.md](figures/15-9/search_iterations/search_iterations.md)
- Anomaly review: [figures/15-9/anomaly_reviews/anomaly_review.md](figures/15-9/anomaly_reviews/anomaly_review.md)
- Discrepancy log: [figures/15-9/discrepancy_logs/discrepancy_log.md](figures/15-9/discrepancy_logs/discrepancy_log.md)
- Review checklist: [figures/15-9/review_checklist.md](figures/15-9/review_checklist.md)
- Lineage: [figures/15-9/lineage/lineage.json](figures/15-9/lineage/lineage.json)
- Reconstruction script: [scripts/reconstruct_15_9.py](scripts/reconstruct_15_9.py)
- Metadata: [figures/15-9/figure.json](figures/15-9/figure.json)
...
- Provenance: [figures/18-1/provenance/provenance.md](figures/18-1/provenance/provenance.md)
- Source log: [figures/18-1/source_logs/source_log.md](figures/18-1/source_logs/source_log.md)
- Search log: [figures/18-1/search_iterations/search_iterations.md](figures/18-1/search_iterations/search_iterations.md)
- Anomaly review: [figures/18-1/anomaly_reviews/anomaly_review.md](figures/18-1/anomaly_reviews/anomaly_review.md)
- Discrepancy log: [figures/18-1/discrepancy_logs/discrepancy_log.md](figures/18-1/discrepancy_logs/discrepancy_log.md)
...
- Provenance: [figures/18-3/provenance/provenance.md](figures/18-3/provenance/provenance.md)
- Source log: [figures/18-3/source_logs/source_log.md](figures/18-3/source_logs/source_log.md)
- Search log: [figures/18-3/search_iterations/search_iterations.md](figures/18-3/search_iterations/search_iterations.md)
- Anomaly review: [figures/18-3/anomaly_reviews/anomaly_review.md](figures/18-3/anomaly_reviews/anomaly_review.md)
