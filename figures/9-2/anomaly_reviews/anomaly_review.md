...
- Source provenance: Milanovic 2016 figure 3.1 underlying table was not recovered as an inspectable data file.
- Recommended next action: Recover Milanovic 2016 figure 3.1 spreadsheet or publisher/author supplementary data.
