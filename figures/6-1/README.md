...
Scientific status: `blocked_external_source`. Execution: `processed`.
...
- Original reference: [plots/comparisons/kindle_reference_figure_6_1.png](plots/comparisons/kindle_reference_figure_6_1.png)
...
- Original reference: `plots/comparisons/kindle_reference_figure_6_1.png`
- Book-period reconstruction: `plots/book_period/figure_6_1_book_period_reconstruction.png`
- Extended reconstruction: `plots/extended/figure_6_1_extended_reconstruction.png`
- Book-period comparison: `plots/comparisons/figure_6_1_book_period_comparison.png`
- Extended comparison: `plots/comparisons/figure_6_1_extended_comparison.png`
