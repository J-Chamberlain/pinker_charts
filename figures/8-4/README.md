...
- Book period reconstruction: [plots/book_period/figure_8_4_book_period_reconstruction.png](plots/book_period/figure_8_4_book_period_reconstruction.png)
- Extended reconstruction: [plots/book_period/figure_8_4_book_period_reconstruction.png](plots/book_period/figure_8_4_book_period_reconstruction.png)
- Book period comparison: [plots/comparisons/figure_8_4_book_period_review.png](plots/comparisons/figure_8_4_book_period_review.png)
- Extended comparison: [plots/comparisons/figure_8_4_extended_review.png](plots/comparisons/figure_8_4_extended_review.png)
...
- Original reference: `plots/comparisons/kindle_reference_figure_8_4.png`
- Book-period reconstruction: `plots/book_period/figure_8_4_book_period_reconstruction.png`
- Extended reconstruction: `plots/extended/figure_8_4_extended_reconstruction.png`
- Book-period comparison: `plots/comparisons/figure_8_4_book_period_comparison.png`
- Extended comparison: `plots/comparisons/figure_8_4_extended_comparison.png`
