...
Scientific status: `partial_match`. Execution: `processed`.
...
- Book period reconstruction: [plots/book_period/figure_7_2_book_period_reconstruction.png](plots/book_period/figure_7_2_book_period_reconstruction.png)
- Extended reconstruction: [plots/extended/figure_7_2_extended_reconstruction.png](plots/extended/figure_7_2_extended_reconstruction.png)
- Book period comparison: [plots/comparisons/figure_7_2_book_period_review.png](plots/comparisons/figure_7_2_book_period_review.png)
- Extended comparison: [plots/comparisons/figure_7_2_extended_review.png](plots/comparisons/figure_7_2_extended_review.png)
...
- Original reference: `plots/comparisons/kindle_reference_figure_7_2.png`
- Book-period reconstruction: `plots/book_period/figure_7_2_book_period_reconstruction.png`
- Extended reconstruction: `plots/extended/figure_7_2_extended_reconstruction.png`
- Book-period comparison: `plots/comparisons/figure_7_2_book_period_comparison.png`
- Extended comparison: `plots/comparisons/figure_7_2_extended_comparison.png`
