...
- Download log: [source_logs/downloads.json](source_logs/downloads.json)
...
- Book period reconstruction: [plots/book_period/figure_14_2_book_period.png](plots/book_period/figure_14_2_book_period.png)
- Extended reconstruction: [plots/extended/figure_14_2_extended.png](plots/extended/figure_14_2_extended.png)
- Diagnostic: [plots/diagnostics/world_aggregation.png](plots/diagnostics/world_aggregation.png)
- Book period clean: [data/clean/figure_14_2_book_period.csv](data/clean/figure_14_2_book_period.csv)
- Successor clean: [data/clean/figure_14_2_successor.csv](data/clean/figure_14_2_successor.csv)
- Diagnostic clean: [data/clean/figure_14_2_diagnostic.csv](data/clean/figure_14_2_diagnostic.csv)
...
- Book period comparison: [plots/comparisons/figure_14_2_book_period_review.png](plots/comparisons/figure_14_2_book_period_review.png)
- Extended comparison: [plots/comparisons/figure_14_2_extended_review.png](plots/comparisons/figure_14_2_extended_review.png)
