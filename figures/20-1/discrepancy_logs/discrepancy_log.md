# Figure 20-1 discrepancy log

| Issue | Classification | Action | Remaining |
|---|---|---|---|
| ESS1-6 input not downloaded | Major | Preserved official documentation and build route | Authorized ESS download required |
