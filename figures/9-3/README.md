...
This directory contains the current Figure 9-3 source-recovery package. The
2026-07-09 pass inspected the Supplemental Graphics PDF, identified Milanovic's
likely source workbook by name (`US_and_uk.xls` / `uk_and_usa.xls`), and
documented why the workbook remains unrecovered. See `provenance/provenance.md`,
`source_logs/source_log.md`, and `anomaly_reviews/anomaly_review.md` for the
blocked reconstruction decision.
